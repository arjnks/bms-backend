...
<head>
<meta charset="UTF-8">
<title>Leo Pharma - Tax Invoice V1</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .company-cell { width: 40%; border-right: 1px solid #000; font-size: 8px; line-height: 1.3; }
  .company-name { font-size: 13px; font-weight: bold; margin-bottom: 3px; }
  .inv-title-cell { width: 22%; border-right: 1px solid #000; text-align: center; font-size: 8px; }
  .cust-cell { width: 23%; font-size: 8px; position: relative; }
  
  /* E-Way Row */
  .eway-table { border: 1px solid #000; border-bottom: none; font-size: 8px; }
  ...
  .items-table th { border: 1px solid #000; font-size: 7px; background: #fff; font-weight: bold; text-align: center; }
  ...
  .footer-right { width: 25%; padding: 3px; }

  .summary-table td { border: none; font-size: 8px; padding: 2px; }
  .summary-table td:last-child { text-align: right; font-weight: bold; }
  .bill-amt-row { border-top: 1px solid #000; font-size: 11px !important; font-weight: bold; }

  .bank-gst-table td { padding: 3px; font-size: 8px; vertical-align: top; }
  ...
  .prep-table td { border-bottom: 1px solid #000; font-size: 8px; }
</style>
</head>
<body>
  ...
  <table class="header-table">
    <tr>
      ...
      <td class="inv-title-cell">
        <strong style="font-size:12px; border-bottom:1px solid #000; display:block; padding-bottom:3px;">TAX INVOICE</strong>
        <div style="margin:5px 0;"><strong>- CREDIT -</strong></div>
  ...
  <table class="footer-table">
    <tr>
      <td class="footer-left">
        <div style="padding:3px; border-bottom:1px solid #000; font-size:8px;"><strong>Message :</strong></div>
        <table class="bank-gst-table">
          <tr>
            ...
            <td class="gst-cell">
              ...
              <table class="prep-table" style="margin-top:2px;">
                <tr>
        ...
        <div style="padding:3px; border-bottom:1px solid #000; font-size:8px;">
