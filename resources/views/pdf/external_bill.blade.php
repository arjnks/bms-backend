...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: Arial, sans-serif; font-size: 8px; background: #fff; color: #000; }
  ...
  .logo-cell { text-align: center; width: 15%; border-right: 1px solid #000; }
  .logo-circle {
  ...
  .company-cell { width: 40%; border-right: 1px solid #000; font-size: 7.5px; line-height: 1.2; }
  .company-name { font-size: 11px; font-weight: bold; margin-bottom: 2px; }
  .inv-title-cell { width: 22%; border-right: 1px solid #000; text-align: center; font-size: 7.5px; }
  .cust-cell { width: 23%; font-size: 7.5px; position: relative; }
  
  /* E-Way Row */
  .eway-table { border: 1px solid #000; border-bottom: none; font-size: 7.5px; }
  ...
  .items-table th { border: 1px solid #000; font-size: 6.5px; background: #fff; font-weight: bold; text-align: center; }
  .items-table td { border-left: 1px solid #000; border-right: 1px solid #000; text-align: center; font-size: 7px; padding: 1px; }
  .items-table td.left { text-align: left; }
  .items-table tr.empty-row td { height: 10px; } /* Smaller filler height */

  /* Footer Section */
  .footer-table { border: 1px solid #000; border-top: 1px solid #000; }
  .footer-left { width: 75%; border-right: 1px solid #000; padding: 0; }
  .footer-right { width: 25%; padding: 2px; }

  .summary-table td { border: none; font-size: 7.5px; padding: 1px; }
  .summary-table td:last-child { text-align: right; font-weight: bold; }
  .bill-amt-row { border-top: 1px solid #000; font-size: 10px !important; font-weight: bold; }

  .bank-gst-table td { padding: 2px; font-size: 7.5px; vertical-align: top; }
  .bank-cell { width: 30%; border-right: 1px solid #000; border-bottom: 1px solid #000; }
  .gst-cell { width: 70%; border-bottom: 1px solid #000; padding: 0 !important; }

  .inner-gst-table th, .inner-gst-table td { border: 1px solid #000; font-size: 6.5px; text-align: right; padding: 1px; }
  .inner-gst-table th { text-align: center; font-weight: bold; }

  .prep-table td { border-bottom: 1px solid #000; font-size: 7px; }
</style>
</head>
<body>
...
if (!function_exists('numToWords')) {
    function numToWords($num) { return "TEN THOUSAND FOUR HUNDRED AND ONE"; } // Simplified for preview
}
  ...
  <table class="header-table">
    <tr>
      ...
      <td class="inv-title-cell">
        <strong style="font-size:10px; border-bottom:1px solid #000; display:block; padding-bottom:1px;">TAX INVOICE</strong>
  ...
  <table class="footer-table">
    <tr>
      ...
      <td class="footer-right">
        ...
        <div style="text-align:right; font-size:7px; font-weight:bold; margin-top:10px;">For LEO PHARMA<br>DISTRIBUTORS P.LTD</div>
      </td>
    </tr>
  </table>
</div>
